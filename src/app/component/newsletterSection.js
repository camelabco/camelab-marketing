    ...
    <>
      {smallNewsletter ? (<section className={newletterStyles['newsletter-section']}>
        <div className='container'>
          <div className={newletterStyles['small-newsletter']}>
            <div className={newletterStyles['small-letter']}>
              <div className='d-flex gap-2 align-items-center'>
                <Image src='/images/newsletter/users.svg' alt='users' height={32} width={80} />
                <h5>900K+ Download Application</h5>
              </div>
              <h6>{heading}</h6>
              <button className='primary-button white'>Request a Demo</button>
            </div>
          </div>
        </div>
      </section>) : (<section className={newletterStyles['newsletter-section']}>
        <div className='container'>
