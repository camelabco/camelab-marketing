...
export default function AnimatedImgSection({ reverse = false , heighLight="", title = "Our Content Creators are ready to make Brand Collaboration" ,description = "Social is a user-generated content creation hub that connects brands with a community of over 17,000 Saudi based content creators. Brands can easily collaborate with these creators to produce authentic and engaging." }) {
    return (
